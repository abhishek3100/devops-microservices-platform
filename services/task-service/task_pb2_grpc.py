...
class TaskServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTasks = channel.unary_unary(
                ...
                request_serializer=task__pb2.GetTasksRequest.SerializeToString,
                response_deserializer=task__pb2.GetTasksResponse.FromString,
                _registered_method=True)
...
def add_TaskServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetTasks': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTasks,
                    request_deserializer=task__pb2.GetTasksRequest.FromString,
                    response_serializer=task__pb2.GetTasksResponse.SerializeToString,
            ),
    }
...
class TaskService(object):
    ...
    def GetTasks(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/task.TaskService/GetTasks',
            task__pb2.GetTasksRequest.SerializeToString,
            task__pb2.GetTasksResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
